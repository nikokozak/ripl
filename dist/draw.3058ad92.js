...
exports.library = exports.NorthOp = void 0;

var settings_1 = __importDefault(require("./settings"));

var utils_1 = require("./utils");

var NorthOp = function () {
  ...
  NorthOp.prototype.draw = function () {
    for (var cI = 0; cI + 1 < this.commands.length; cI++) {
      var command = this.commands[cI];
      var next_command = this.commands[cI + 1];
      settings_1.default.canvas_context.translate(command.x, command.y);
      settings_1.default.canvas_context.lineTo(next_command.x, next_command.y);
    }

    settings_1.default.canvas_context.fillStyle = settings_1.default.bg_color;
    ...
    settings_1.default.canvas_context.fillStyle = settings_1.default.font_color;
...
var Ripl = function () {
  ...
  Ripl.prototype.write = function (glyph, x, y) {
    var new_op = new operators_1.default[glyph](x, y);
...
},{"./operators":"scripts/operators.ts"}],"scripts/cursor.ts":[function(require,module,exports) {
"use strict";
...
},{"./settings":"scripts/settings.ts","./utils":"scripts/utils.ts"}],"scripts/draw.ts":[function(require,module,exports) {
"use strict";
...
var cursor = new cursor_1.default(ripl);
...
draw();
},{"./settings":"scripts/settings.ts","./utils":"scripts/utils.ts","./grid":"scripts/grid.ts","./ripl":"scripts/ripl.ts","./cursor":"scripts/cursor.ts"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/draw.ts"], null)
//# sourceMappingURL=/draw.3058ad92.js.map